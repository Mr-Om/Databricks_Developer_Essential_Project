...
// 
// ## Testing your Code
// There are 4 test functions imported into this notebook:
// * realityCheckBronze
// * realityCheckStatic
// * realityCheckSilver
// * realityCheckGold
// 
// To run automated tests against your code, you will call a `realityCheck` function and pass the function you write as an argument. The testing suite will call your functions against a different dataset so it's important that you don't change the parameters in the function definitions. 
// 
// To test your code yourself, simply call your function, passing the correct arguments. 
...
// %md
// 
// ## Call your writeToBronze function
// 
// To start the stream, call your `writeToBronze` function in the cell below.
...
// ## Check your answer 
// 
// Call the realityCheckBronze function with your writeToBronze function as an argument.
...
// 
// Complete the `loadStaticData` function to perform the following tasks:
// 
// * Register a static lookup table to associate `deviceId` with `deviceType` (android or ios).
